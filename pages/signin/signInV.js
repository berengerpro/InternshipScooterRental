...
const signinPage = ({ errors, handleChange, handleSubmit, isLoggedIn, isSubmitting, touched, router }) => {
  return (
          ...
          <Card className='card-form'>
            <Card.Body>
              ...
              <Form noValidate onSubmit={handleSubmit}>
                ...
                {/* ------------------------- Submit-------------------------  */}
                <Button className='btn-block' disabled={isSubmitting} type='submit'>{'Sign In'}</Button>
              </Form>
              <br />
